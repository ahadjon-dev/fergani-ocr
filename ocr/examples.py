...
class EnhancedOCRView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"success": True, "text": text, "enhanced": True, "filename": image_file.name})
...
class BatchOCRView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"success": True, "total_images": len(images), "results": results})
...
class CustomConfigOCRView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({"success": True, "text": text, "config_used": config_type, "filename": image_file.name})
...
class OCRWithConfidenceView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        meets_threshold = confidence_data and confidence_data["average_confidence"] >= min_confidence
