...
class OCRDocumentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["uuid", "file_hash", "uploaded_at", "processed_at", "deleted_at", "archived_at", "file_size_display"]
    date_hierarchy = "uploaded_at"

    fieldsets = (
        ("Identification", {"fields": ("uuid", "file_name", "file_type")}),
        ("File Information", {"fields": ("file", "file_size", "file_size_display", "file_hash")}),
        ("Processing", {"fields": ("status", "language", "processed_at")}),
        ("Timestamps", {"fields": ("uploaded_at", "archived_at", "is_deleted", "deleted_at"), "classes": ("collapse",)}),
    )
...
class OCRResultAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["uuid", "word_count", "character_count", "created_at", "text_preview", "processing_time_display"]
    date_hierarchy = "created_at"

    fieldsets = (
        ("Identification", {"fields": ("uuid", "document")}),
        ("Extraction Results", {"fields": ("extracted_text", "text_preview", "word_count", "character_count")}),
        (
            "Processing Details",
            {"fields": ("extraction_method", "language", "processing_time_ms", "processing_time_display", "confidence_score")},
        ),
...
class PDFPageResultAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Identification", {"fields": ("result", "page_number")}),
        ("Extraction Results", {"fields": ("extracted_text", "text_preview", "word_count", "character_count")}),
        ("Processing Details", {"fields": ("extraction_method", "confidence_score")}),
        ("Metadata", {"fields": ("created_at",), "classes": ("collapse",)}),
    )
...
class OCRProcessingLogAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "document_link", "level_badge", "message_preview", "created_at"]
    ...
    fieldsets = (
        ("Log Information", {"fields": ("document", "level", "message")}),
