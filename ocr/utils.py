...
class PDFProcessor:
    ...
    @staticmethod
    def convert_pdf_to_image(pdf_file, page_number: int = 1):
        """
        Convert a specific page of PDF to PIL Image
        ...
        Raises:
            ...
            ValueError: If page could not be extracted
        """
        if not PDF_SUPPORT:
            raise ImportError(
    ...
    def extract_text_from_pdf(pdf_file, language="eng", use_ocr=True):
        ...
        results = {"text": "", "pages": [], "total_pages": 0, "method": "text_extraction", "has_text": False}
        ...
        try:
            ...
            for page_num, page in enumerate(pdf_reader.pages, 1):
                ...
                results["pages"].append({"page_number": page_num, "text": text, "method": "text_extraction"})
            ...
            if use_ocr and len(combined_text.strip()) < 50:
                ...
                results = PDFProcessor._extract_with_ocr(pdf_bytes, language, results["total_pages"])
            else:
    ...
    def _extract_with_ocr(pdf_bytes, language, total_pages):
        ...
        """
        results = {"text": "", "pages": [], "total_pages": total_pages, "method": "ocr", "has_text": True}
        ...
        try:
            ...
            for page_num, image in enumerate(images, 1):
                ...
                results["pages"].append({"page_number": page_num, "text": text, "method": "ocr", "image_size": image.size})
    ...
    def extract_specific_pages(pdf_file, page_numbers: List[int], language="eng", use_ocr=True):
        ...
        results = {"text": "", "pages": [], "total_pages": len(pdf_reader.pages), "requested_pages": page_numbers}
        ...
        for page_num in page_numbers:
            ...
            all_text.append(text)
            results["pages"].append({"page_number": page_num, "text": text})
